...
function Header(){
    return (
        ...
        <ul className="flex justify-between gap-12 font-medium pt-1.5">
            ...
            <div className="flex">
                <FaCartShopping className="mt-1 mx-2"/>
                <li>Cart</li>
            </div>
        </ul>
