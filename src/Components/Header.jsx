    ...
    return (
        ...
        <ul className="flex justify-between gap-12 font-medium pt-1.5">
            ...
            <div className="flex">
                ...
                <li className=" "><Link to='./cart'>Cart {itemCount.length}</Link> </li>
            </div>
        </ul>
